import { MAX_CONN_PARAMS_SIZE } from "@tivet-gg/actor-common/network";
...
import type * as wsToServer from "@tivet-gg/actor-protocol/ws/to_server";
...
export class ActorHandleRaw {
	 ...
	 * @see {@link https://tivet.gg/docs/events|Events Documentation}
	 */
