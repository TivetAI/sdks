import type { ActorTags } from "@tivet-gg/actor-common/utils";
import type { ProtocolFormat } from "@tivet-gg/actor-protocol/ws";
import type {
	ActorsRequest,
	ActorsResponse,
	TivetConfigResponse,
} from "@tivet-gg/manager-protocol";
import type { CreateRequest } from "@tivet-gg/manager-protocol/query";
 ...
 * @see {@link https://tivet.gg/docs/edge|Edge Networking}
 * @see {@link https://tivet.gg/docs/regions|Available Regions}
 */
...
export class Client {
	 ...
	 *
	 * @param {string | Promise<string>} managerEndpointPromise - The manager endpoint or a promise resolving to it. See {@link https://tivet.gg/docs/setup|Initial Setup} for instructions on getting the manager endpoint.
	 ...
	 * @returns {Promise<ActorHandle<A>>} - A promise resolving to the actor handle.
	 * @see {@link https://tivet.gg/docs/manage#client.get}
	 */
	async get<A = unknown>(
		tags: ActorTags,
		opts?: GetOptions,
	 ...
	 * @returns {Promise<ActorHandle<A>>} - A promise resolving to the actor handle.
	 * @see {@link https://tivet.gg/docs/manage#client.create}
	 */
	 ...
	 * @see {@link https://tivet.gg/docs/manage#client}
	 */
	...
	async #fetchRegion(): Promise<Region | undefined> {
		try {
			...
			// Fetch the region
			//
			// This is fetched from the client instead of the manager so Tivet
