...
import {
	op_tivet_kv_delete,
	op_tivet_kv_delete_all,
	op_tivet_kv_delete_batch,
	op_tivet_kv_get,
	op_tivet_kv_get_batch,
	op_tivet_kv_list,
	op_tivet_kv_put,
	op_tivet_kv_put_batch,
} from "ext:core/ops";
...
export async function getBatch<K extends Array<unknown>, V>(
	...
	const entries: [OutKey, OutEntry][] = await op_tivet_kv_get_batch(
...
export async function list<K, V>(
	...
	const entries: [OutKey, OutEntry][] = await op_tivet_kv_list(
		query,
