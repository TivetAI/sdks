import { type Logger, setupLogging } from "@tivet-gg/actor-common/log";
import { listObjectMethods } from "@tivet-gg/actor-common/reflect";
import { isJsonSerializable } from "@tivet-gg/actor-common/utils";
import type { ActorContext, Metadata } from "@tivet-gg/actor-core";
import * as protoHttpRpc from "@tivet-gg/actor-protocol/http/rpc";
import {
	type ProtocolFormat,
	ProtocolFormatSchema,
} from "@tivet-gg/actor-protocol/ws";
import type * as wsToClient from "@tivet-gg/actor-protocol/ws/to_client";
 ...
 *
 * @see {@link https://tivet.gg/docs/connections|Connections Documentation}
 */
 ...
 *
 * @see {@link https://tivet.gg/docs/state|State Documentation}
 */
...
/**
 * Abstract class representing a Tivet Actor. Extend this class to implement logic for your actor.
 *
 * @template State Represents the actor's state, which is stored in-memory and persisted automatically. This allows you to work with data without added latency while still being able to survive crashes & upgrades. Must define `_onInitialize` to create the initial state. For more details, see the {@link https://tivet.gg/docs/state|State Documentation}.
 * @template ConnParams Represents the parameters passed when a client connects to the actor. These parameters can be used for authentication or other connection-specific logic. For more details, see the {@link https://tivet.gg/docs/connections|Connections Documentation}.
 * @template ConnState Represents the state of a connection, which is initialized from the data returned by `_onBeforeConnect`. This state can be accessed in any actor method using `connection.state`. For more details, see the {@link https://tivet.gg/docs/connections|Connections Documentation}.
 * @see {@link https://tivet.gg/docs|Documentation}
 * @see {@link https://tivet.gg/docs/setup|Initial Setup}
 * @see {@link https://tivet.gg/docs/manage|Create & Manage Actors}
 * @see {@link https://tivet.gg/docs/rpc|Remote Procedure Calls}
 * @see {@link https://tivet.gg/docs/state|State}
 * @see {@link https://tivet.gg/docs/events|Events}
 * @see {@link https://tivet.gg/docs/lifecycle|Lifecycle}
 * @see {@link https://tivet.gg/docs/connections|Connections}
 * @see {@link https://tivet.gg/docs/authentication|Authentication}
 * @see {@link https://tivet.gg/docs/logging|Logging}
 */
...
> {
	...
	/**
	 * Called by Tivet runtime to start a new actor. This class must use `export default` in order to be called automatically.
	 *
	...
	#runServer() {
		...
		app.get("/", (c) => {
			...
			return c.text(
				"This is a Tivet Actor\n\nLearn more at https://tivet.gg",
			);
		});
		...
		app.get(
			...
			// 			"https://hub.tivet.gg",
			// 		].includes(origin) ||
			// 			origin.endsWith(".tivet-hub-7jb.pages.dev")
			// 			? origin
			// 			: "https://hub.tivet.gg";
			// 	},
			// }),
	...
	async #handleHttpRpc(c: HonoContext) {
		...
		try {
			...
			if (error instanceof errors.ActorError && error.public) {
				...
				metadata = {
					url: `https://hub.tivet.gg/projects/${this.#ctx.metadata.project.slug}/environments/${this.#ctx.metadata.environment.slug}/actors?actorId=${this.#ctx.metadata.actor.id}`,
	 ...
	 *
	 * @see _state
	 * @see {@link https://tivet.gg/docs/lifecycle|Lifecycle Documentation}
	 */
	 ...
	 * @see {@link https://tivet.gg/docs/lifecycle|Lifecycle Documentation}
	 * @see {@link https://tivet.gg/docs/authentication|Authentication Documentation}
	 */
	 ...
	 *
	 * @see {@link https://tivet.gg/docs/metadata|Metadata Documentation}
	 */
	 ...
	 *
	 * @see {@link https://tivet.gg/docs/logging|Logging Documentation}
	 */
