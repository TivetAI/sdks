...
pub struct CloudRegionTier {
    ...
    #[serde(rename = "tivet_cores_denominator")]
    pub tivet_cores_denominator: i32,
    /// Together with the denominator, denotes the portion of the CPU a given server uses.
    #[serde(rename = "tivet_cores_numerator")]
    pub tivet_cores_numerator: i32,
...
impl CloudRegionTier {
    ...
    pub fn new(bandwidth: i32, cpu: i32, disk: i32, memory: i32, price_per_second: i32, tivet_cores_denominator: i32, tivet_cores_numerator: i32, tier_name_id: String) -> CloudRegionTier {
        CloudRegionTier {
            bandwidth,
            cpu,
            disk,
            memory,
            price_per_second,
            tivet_cores_denominator,
            tivet_cores_numerator,
            tier_name_id,
        }
    }
}
