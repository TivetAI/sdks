...
export class Auth {
     ...
     */
    public async inspect(requestOptions?: Auth.RequestOptions): Promise<Tivet.cloud.InspectResponse> {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.TivetTimeoutError("Timeout exceeded when calling GET /cloud/auth/inspect.");
            case "unknown":
                throw new errors.TivetError({
