...
export class Tiers {
     ...
     */
    public async getRegionTiers(requestOptions?: Tiers.RequestOptions): Promise<Tivet.cloud.GetRegionTiersResponse> {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.TivetTimeoutError("Timeout exceeded when calling GET /cloud/region-tiers.");
            case "unknown":
                throw new errors.TivetError({
