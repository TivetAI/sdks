...
export class Logs {
     ...
     * @param {Tivet.cloud.games.namespaces.ListNamespaceLobbiesRequest} request
    ...
    public async listNamespaceLobbies(
        gameId: string,
        namespaceId: string,
        request: Tivet.cloud.games.namespaces.ListNamespaceLobbiesRequest = {},
        requestOptions?: Logs.RequestOptions
    ): Promise<Tivet.cloud.games.namespaces.ListNamespaceLobbiesResponse> {
    ...
    public async getNamespaceLobby(
        ...
        lobbyId: string,
        requestOptions?: Logs.RequestOptions
    ): Promise<Tivet.cloud.games.namespaces.GetNamespaceLobbyResponse> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.TivetEnvironment.Production,
