...
export class Versions {
     ...
     *
     * @param {string} gameId
     * @param {Tivet.cloud.games.CreateGameVersionRequest} request
    ...
    public async createGameVersion(
        gameId: string,
        request: Tivet.cloud.games.CreateGameVersionRequest,
        requestOptions?: Versions.RequestOptions
    ): Promise<Tivet.cloud.games.CreateGameVersionResponse> {
    ...
    public async reserveVersionName(
        gameId: string,
        requestOptions?: Versions.RequestOptions
    ): Promise<Tivet.cloud.games.ReserveVersionNameResponse> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.TivetEnvironment.Production,
     ...
     *
     * @param {string} gameId
     * @param {Tivet.cloud.games.ValidateGameVersionRequest} request
     * @param {Versions.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Tivet.InternalError}
     * @throws {@link Tivet.RateLimitError}
    ...
    public async validateGameVersion(
        gameId: string,
        request: Tivet.cloud.games.ValidateGameVersionRequest,
        requestOptions?: Versions.RequestOptions
    ): Promise<Tivet.cloud.games.ValidateGameVersionResponse> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.TivetEnvironment.Production,
    ...
    public async getGameVersionById(
        ...
        versionId: string,
        requestOptions?: Versions.RequestOptions
    ): Promise<Tivet.cloud.games.GetGameVersionByIdResponse> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.TivetEnvironment.Production,
