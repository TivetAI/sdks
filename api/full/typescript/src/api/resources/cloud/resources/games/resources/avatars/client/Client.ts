...
export class Avatars {
    ...
    public async listGameCustomAvatars(
    ...
    ): Promise<Tivet.cloud.games.ListGameCustomAvatarsResponse> {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.TivetTimeoutError("Timeout exceeded when calling GET /cloud/games/{game_id}/avatars.");
            case "unknown":
                throw new errors.TivetError({
     ...
     * Complete upload with `tivet.api.cloud#CompleteCustomAvatarUpload`.
     *
     * @param {string} gameId
     * @param {Tivet.cloud.games.PrepareCustomAvatarUploadRequest} request
     * @param {Avatars.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Tivet.InternalError}
     * @throws {@link Tivet.RateLimitError}
    ...
    public async prepareCustomAvatarUpload(
        gameId: string,
        request: Tivet.cloud.games.PrepareCustomAvatarUploadRequest,
        requestOptions?: Avatars.RequestOptions
    ): Promise<Tivet.cloud.games.PrepareCustomAvatarUploadResponse> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.TivetEnvironment.Production,
