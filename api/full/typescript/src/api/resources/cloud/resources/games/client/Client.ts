...
export class Games {
     ...
     *
     * @param {Tivet.cloud.games.GetGamesRequest} request
    ...
    public async getGames(
        request: Tivet.cloud.games.GetGamesRequest = {},
        requestOptions?: Games.RequestOptions
    ): Promise<Tivet.cloud.games.GetGamesResponse> {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.TivetTimeoutError("Timeout exceeded when calling GET /cloud/games.");
            case "unknown":
                throw new errors.TivetError({
     ...
     * Creates a new game.
     *
     * @param {Tivet.cloud.games.CreateGameRequest} request
     * @param {Games.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Tivet.InternalError}
     * @throws {@link Tivet.RateLimitError}
    ...
    public async createGame(
        request: Tivet.cloud.games.CreateGameRequest,
        requestOptions?: Games.RequestOptions
    ): Promise<Tivet.cloud.games.CreateGameResponse> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.TivetEnvironment.Production,
                "/cloud/games"
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.TivetTimeoutError("Timeout exceeded when calling POST /cloud/games.");
            case "unknown":
                throw new errors.TivetError({
                    message: _response.error.errorMessage,
                });
     ...
     *
     * @param {Tivet.cloud.games.ValidateGameRequest} request
     * @param {Games.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Tivet.InternalError}
     * @throws {@link Tivet.RateLimitError}
    ...
    public async validateGame(
        request: Tivet.cloud.games.ValidateGameRequest,
        requestOptions?: Games.RequestOptions
    ): Promise<Tivet.cloud.games.ValidateGameResponse> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.TivetEnvironment.Production,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.TivetTimeoutError("Timeout exceeded when calling POST /cloud/games/validate.");
            case "unknown":
                throw new errors.TivetError({
                    message: _response.error.errorMessage,
                });
     ...
     *
     * @param {string} gameId
     * @param {Tivet.cloud.games.GetGameByIdRequest} request
     * @param {Games.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Tivet.InternalError}
     * @throws {@link Tivet.RateLimitError}
    ...
    public async getGameById(
        gameId: string,
        request: Tivet.cloud.games.GetGameByIdRequest = {},
        requestOptions?: Games.RequestOptions
    ): Promise<Tivet.cloud.games.GetGameByIdResponse> {
        const { watchIndex } = request;
        const _queryParams: Record<string, string | string[] | object | object[]> = {};
        if (watchIndex != null) {
            _queryParams["watch_index"] = watchIndex;
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.TivetTimeoutError("Timeout exceeded when calling GET /cloud/games/{game_id}.");
            case "unknown":
                throw new errors.TivetError({
                    message: _response.error.errorMessage,
                });
     ...
     *
     * @param {string} gameId
     * @param {Tivet.cloud.games.GameBannerUploadPrepareRequest} request
     * @param {Games.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Tivet.InternalError}
     * @throws {@link Tivet.RateLimitError}
    ...
    public async gameBannerUploadPrepare(
        gameId: string,
        request: Tivet.cloud.games.GameBannerUploadPrepareRequest,
        requestOptions?: Games.RequestOptions
    ): Promise<Tivet.cloud.games.GameBannerUploadPrepareResponse> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.TivetEnvironment.Production,
     ...
     *
     * @param {string} gameId
     * @param {Tivet.cloud.games.GameLogoUploadPrepareRequest} request
     * @param {Games.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Tivet.InternalError}
     * @throws {@link Tivet.RateLimitError}
    ...
    public async gameLogoUploadPrepare(
        gameId: string,
        request: Tivet.cloud.games.GameLogoUploadPrepareRequest,
        requestOptions?: Games.RequestOptions
    ): Promise<Tivet.cloud.games.GameLogoUploadPrepareResponse> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.TivetEnvironment.Production,
