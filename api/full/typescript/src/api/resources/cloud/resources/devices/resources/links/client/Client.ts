...
export class Links {
    ...
    public async prepare(
    ...
    ): Promise<Tivet.cloud.devices.PrepareDeviceLinkResponse> {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.TivetTimeoutError("Timeout exceeded when calling POST /cloud/devices/links.");
            case "unknown":
                throw new errors.TivetError({
    ...
    /**
     * @param {Tivet.cloud.devices.GetDeviceLinkRequest} request
     * @param {Links.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Tivet.InternalError}
     * @throws {@link Tivet.RateLimitError}
     ...
     */
    public async get(
        request: Tivet.cloud.devices.GetDeviceLinkRequest,
        requestOptions?: Links.RequestOptions
    ): Promise<Tivet.cloud.devices.GetDeviceLinkResponse> {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.TivetTimeoutError("Timeout exceeded when calling GET /cloud/devices/links.");
            case "unknown":
                throw new errors.TivetError({
                    message: _response.error.errorMessage,
                });
    ...
    /**
     * @param {Tivet.cloud.devices.CompleteDeviceLinkRequest} request
     * @param {Links.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Tivet.InternalError}
     * @throws {@link Tivet.RateLimitError}
    ...
    public async complete(
        request: Tivet.cloud.devices.CompleteDeviceLinkRequest,
        requestOptions?: Links.RequestOptions
    ): Promise<void> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.TivetTimeoutError("Timeout exceeded when calling POST /cloud/devices/links/complete.");
            case "unknown":
                throw new errors.TivetError({
                    message: _response.error.errorMessage,
                });
