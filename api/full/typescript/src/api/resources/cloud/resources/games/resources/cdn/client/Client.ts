...
export class Cdn {
    ...
    ): Promise<Tivet.cloud.games.ListGameCdnSitesResponse> {
     ...
     *
     * @param {string} gameId
     * @param {Tivet.cloud.games.CreateGameCdnSiteRequest} request
     * @param {Cdn.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Tivet.InternalError}
     * @throws {@link Tivet.RateLimitError}
    ...
    public async createGameCdnSite(
        gameId: string,
        request: Tivet.cloud.games.CreateGameCdnSiteRequest,
        requestOptions?: Cdn.RequestOptions
    ): Promise<Tivet.cloud.games.CreateGameCdnSiteResponse> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.TivetEnvironment.Production,
                `/cloud/games/${encodeURIComponent(gameId)}/cdn/sites`
