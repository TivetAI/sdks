...
export class Groups {
     ...
     *
     * @param {Tivet.cloud.ValidateGroupRequest} request
    ...
    public async validate(
        request: Tivet.cloud.ValidateGroupRequest,
        requestOptions?: Groups.RequestOptions
    ): Promise<Tivet.cloud.ValidateGroupResponse> {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.TivetTimeoutError("Timeout exceeded when calling POST /cloud/groups/validate.");
            case "unknown":
                throw new errors.TivetError({
