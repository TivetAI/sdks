...
export class Cloud {
     ...
     */
    public async bootstrap(requestOptions?: Cloud.RequestOptions): Promise<Tivet.cloud.BootstrapResponse> {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.TivetTimeoutError("Timeout exceeded when calling GET /cloud/bootstrap.");
            case "unknown":
                throw new errors.TivetError({
