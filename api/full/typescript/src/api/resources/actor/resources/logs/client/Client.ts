...
export class Logs {
     ...
     *
     * @param {string} actor
     * @param {Tivet.actor.GetActorLogsRequestQuery} request
    ...
    public async get(
        actor: string,
        request: Tivet.actor.GetActorLogsRequestQuery,
        requestOptions?: Logs.RequestOptions
    ): Promise<Tivet.actor.GetActorLogsResponse> {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.TivetTimeoutError("Timeout exceeded when calling GET /actors/{actor}/logs.");
            case "unknown":
                throw new errors.TivetError({
