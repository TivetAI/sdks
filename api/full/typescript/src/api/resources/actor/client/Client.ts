...
export class Actor {
     ...
     * @param {Tivet.actor.ListActorsRequestQuery} request
    ...
    public async get(
        actor: string,
        request: Tivet.actor.ListActorsRequestQuery = {},
        requestOptions?: Actor.RequestOptions
    ): Promise<Tivet.actor.GetActorResponse> {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.TivetTimeoutError("Timeout exceeded when calling GET /actors/{actor}.");
            case "unknown":
                throw new errors.TivetError({
     ...
     *
     * @param {Tivet.actor.GetActorsRequestQuery} request
     * @param {Actor.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Tivet.InternalError}
     * @throws {@link Tivet.RateLimitError}
     ...
     */
    public async list(
        request: Tivet.actor.GetActorsRequestQuery = {},
        requestOptions?: Actor.RequestOptions
    ): Promise<Tivet.actor.ListActorsResponse> {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.TivetTimeoutError("Timeout exceeded when calling GET /actors.");
            case "unknown":
                throw new errors.TivetError({
                    message: _response.error.errorMessage,
                });
     ...
     *
     * @param {Tivet.actor.CreateActorRequestQuery} request
     * @param {Actor.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Tivet.InternalError}
     * @throws {@link Tivet.RateLimitError}
     ...
     */
    public async create(
        request: Tivet.actor.CreateActorRequestQuery,
        requestOptions?: Actor.RequestOptions
    ): Promise<Tivet.actor.CreateActorResponse> {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.TivetTimeoutError("Timeout exceeded when calling POST /actors.");
            case "unknown":
                throw new errors.TivetError({
                    message: _response.error.errorMessage,
                });
     ...
     *
     * @param {string} actor - The id of the actor to destroy
     * @param {Tivet.actor.DestroyActorRequestQuery} request
     * @param {Actor.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Tivet.InternalError}
     * @throws {@link Tivet.RateLimitError}
    ...
    public async destroy(
        actor: string,
        request: Tivet.actor.DestroyActorRequestQuery = {},
        requestOptions?: Actor.RequestOptions
    ): Promise<Tivet.actor.DestroyActorResponse> {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.TivetTimeoutError("Timeout exceeded when calling DELETE /actors/{actor}.");
            case "unknown":
                throw new errors.TivetError({
                    message: _response.error.errorMessage,
                });
     ...
     * @param {Tivet.actor.UpgradeActorRequestQuery} request
     * @param {Actor.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Tivet.InternalError}
     * @throws {@link Tivet.RateLimitError}
    ...
    public async upgrade(
        actor: string,
        request: Tivet.actor.UpgradeActorRequestQuery,
        requestOptions?: Actor.RequestOptions
    ): Promise<Tivet.actor.UpgradeActorResponse> {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.TivetTimeoutError("Timeout exceeded when calling POST /actors/{actor}/upgrade.");
            case "unknown":
                throw new errors.TivetError({
                    message: _response.error.errorMessage,
                });
     ...
     * Upgrades a dynamic actor.
     *
     * @param {Tivet.actor.UpgradeAllActorsRequestQuery} request
     * @param {Actor.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Tivet.InternalError}
     * @throws {@link Tivet.RateLimitError}
    ...
    public async upgradeAll(
        request: Tivet.actor.UpgradeAllActorsRequestQuery,
        requestOptions?: Actor.RequestOptions
    ): Promise<Tivet.actor.UpgradeAllActorsResponse> {
        const { project, environment, body: _body } = request;
        const _queryParams: Record<string, string | string[] | object | object[]> = {};
        if (project != null) {
            _queryParams["project"] = project;
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.TivetTimeoutError("Timeout exceeded when calling POST /actors/upgrade.");
            case "unknown":
                throw new errors.TivetError({
                    message: _response.error.errorMessage,
                });
