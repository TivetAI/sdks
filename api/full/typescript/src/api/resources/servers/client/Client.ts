...
export class Servers {
    ...
    ): Promise<Tivet.servers.GetServerResponse> {
     ...
     * @param {string} gameId
     * @param {string} environmentId
     * @param {Tivet.servers.GetServersRequest} request
     * @param {Servers.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Tivet.InternalError}
     * @throws {@link Tivet.RateLimitError}
    ...
    public async list(
        gameId: string,
        environmentId: string,
        request: Tivet.servers.GetServersRequest = {},
        requestOptions?: Servers.RequestOptions
    ): Promise<Tivet.servers.ListServersResponse> {
     ...
     * @param {string} gameId
     * @param {string} environmentId
     * @param {Tivet.servers.CreateServerRequest} request
     * @param {Servers.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Tivet.InternalError}
     * @throws {@link Tivet.RateLimitError}
    ...
    public async create(
        gameId: string,
        environmentId: string,
        request: Tivet.servers.CreateServerRequest,
        requestOptions?: Servers.RequestOptions
    ): Promise<Tivet.servers.CreateServerResponse> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.TivetEnvironment.Production,
                `/games/${encodeURIComponent(gameId)}/environments/${encodeURIComponent(environmentId)}/servers`
     ...
     * @param {string} environmentId
     * @param {string} serverId - The id of the server to destroy
     * @param {Tivet.servers.DestroyServerRequest} request
     * @param {Servers.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Tivet.InternalError}
     * @throws {@link Tivet.RateLimitError}
    ...
    public async destroy(
        ...
        environmentId: string,
        serverId: string,
        request: Tivet.servers.DestroyServerRequest = {},
        requestOptions?: Servers.RequestOptions
    ): Promise<Tivet.servers.DestroyServerResponse> {
