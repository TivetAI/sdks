...
export class Builds {
     ...
     * @param {Tivet.servers.GetBuildRequest} request
    ...
    public async get(
        ...
        buildId: string,
        request: Tivet.servers.GetBuildRequest = {},
        requestOptions?: Builds.RequestOptions
    ): Promise<Tivet.servers.GetBuildResponse> {
     ...
     * @param {string} gameId
     * @param {string} environmentId
     * @param {Tivet.servers.ListBuildsRequest} request
     * @param {Builds.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Tivet.InternalError}
     * @throws {@link Tivet.RateLimitError}
    ...
    public async list(
        gameId: string,
        environmentId: string,
        request: Tivet.servers.ListBuildsRequest = {},
        requestOptions?: Builds.RequestOptions
    ): Promise<Tivet.servers.ListBuildsResponse> {
        const { tagsJson } = request;
        const _queryParams: Record<string, string | string[] | object | object[]> = {};
        if (tagsJson != null) {
            _queryParams["tags_json"] = tagsJson;
     ...
     * @param {string} environmentId
     * @param {string} buildId
     * @param {Tivet.servers.PatchBuildTagsRequest} request
     * @param {Builds.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Tivet.InternalError}
     * @throws {@link Tivet.RateLimitError}
    ...
    public async patchTags(
        ...
        environmentId: string,
        buildId: string,
        request: Tivet.servers.PatchBuildTagsRequest,
        requestOptions?: Builds.RequestOptions
    ): Promise<Tivet.servers.PatchBuildTagsResponse> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.TivetEnvironment.Production,
                `/games/${encodeURIComponent(gameId)}/environments/${encodeURIComponent(
     ...
     * @param {string} gameId
     * @param {string} environmentId
     * @param {Tivet.servers.CreateBuildRequest} request
     * @param {Builds.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Tivet.InternalError}
     * @throws {@link Tivet.RateLimitError}
    ...
    public async prepare(
        gameId: string,
        environmentId: string,
        request: Tivet.servers.CreateBuildRequest,
        requestOptions?: Builds.RequestOptions
    ): Promise<Tivet.servers.CreateBuildResponse> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.TivetEnvironment.Production,
