...
export class Activities {
     ...
     *
     * @param {Tivet.identity.ListActivitiesRequest} request
     ...
     */
    public async list(
        request: Tivet.identity.ListActivitiesRequest = {},
        requestOptions?: Activities.RequestOptions
    ): Promise<Tivet.identity.ListActivitiesResponse> {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.TivetTimeoutError("Timeout exceeded when calling GET /identity/activities.");
            case "unknown":
                throw new errors.TivetError({
