...
export class Identity {
     ...
     * Temporary Accounts
     * Until the identity is linked with the Tivet Hub (see `PrepareGameLink`), this identity will be temporary but still behave like all other identities.
     ...
     *
     * @param {Tivet.identity.SetupRequest} request
     ...
     */
    public async setup(
        request: Tivet.identity.SetupRequest = {},
        requestOptions?: Identity.RequestOptions
    ): Promise<Tivet.identity.SetupResponse> {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.TivetTimeoutError("Timeout exceeded when calling POST /identity/identities.");
            case "unknown":
                throw new errors.TivetError({
     ...
     * @param {Tivet.identity.GetProfileRequest} request
     * @param {Identity.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Tivet.InternalError}
     * @throws {@link Tivet.RateLimitError}
    ...
    public async getProfile(
        identityId: string,
        request: Tivet.identity.GetProfileRequest = {},
        requestOptions?: Identity.RequestOptions
    ): Promise<Tivet.identity.GetProfileResponse> {
     ...
     *
     * @param {Tivet.identity.GetSelfProfileRequest} request
     * @param {Identity.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Tivet.InternalError}
     * @throws {@link Tivet.RateLimitError}
    ...
    public async getSelfProfile(
        request: Tivet.identity.GetSelfProfileRequest = {},
        requestOptions?: Identity.RequestOptions
    ): Promise<Tivet.identity.GetProfileResponse> {
        const { watchIndex } = request;
        const _queryParams: Record<string, string | string[] | object | object[]> = {};
     ...
     *
     * @param {Tivet.identity.GetHandlesRequest} request
     * @param {Identity.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Tivet.InternalError}
     * @throws {@link Tivet.RateLimitError}
    ...
    public async getHandles(
        request: Tivet.identity.GetHandlesRequest,
        requestOptions?: Identity.RequestOptions
    ): Promise<Tivet.identity.GetHandlesResponse> {
     ...
     *
     * @param {Tivet.identity.GetSummariesRequest} request
     * @param {Identity.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Tivet.InternalError}
     * @throws {@link Tivet.RateLimitError}
    ...
    public async getSummaries(
        request: Tivet.identity.GetSummariesRequest,
        requestOptions?: Identity.RequestOptions
    ): Promise<Tivet.identity.GetSummariesResponse> {
        const { identityIds } = request;
        const _queryParams: Record<string, string | string[] | object | object[]> = {};
        if (Array.isArray(identityIds)) {
            _queryParams["identity_ids"] = identityIds.map((item) => item);
     ...
     *
     * @param {Tivet.identity.UpdateProfileRequest} request
     * @param {Identity.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Tivet.InternalError}
     * @throws {@link Tivet.RateLimitError}
    ...
    public async updateProfile(
        request: Tivet.identity.UpdateProfileRequest = {},
        requestOptions?: Identity.RequestOptions
    ): Promise<void> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
     ...
     *
     * @param {Tivet.identity.ValidateProfileRequest} request
     * @param {Identity.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Tivet.InternalError}
     * @throws {@link Tivet.RateLimitError}
    ...
    public async validateProfile(
        request: Tivet.identity.ValidateProfileRequest = {},
        requestOptions?: Identity.RequestOptions
    ): Promise<void> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
     ...
     *
     * @param {Tivet.identity.SetGameActivityRequest} request
     * @param {Identity.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Tivet.InternalError}
     * @throws {@link Tivet.RateLimitError}
    ...
    public async setGameActivity(
        request: Tivet.identity.SetGameActivityRequest,
        requestOptions?: Identity.RequestOptions
    ): Promise<void> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
     ...
     *
     * @param {Tivet.identity.UpdateStatusRequest} request
     * @param {Identity.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Tivet.InternalError}
     * @throws {@link Tivet.RateLimitError}
    ...
    public async updateStatus(
        request: Tivet.identity.UpdateStatusRequest,
        requestOptions?: Identity.RequestOptions
    ): Promise<void> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
     ...
     *
     * @param {Tivet.identity.PrepareAvatarUploadRequest} request
     * @param {Identity.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Tivet.InternalError}
     * @throws {@link Tivet.RateLimitError}
    ...
    public async prepareAvatarUpload(
        request: Tivet.identity.PrepareAvatarUploadRequest,
        requestOptions?: Identity.RequestOptions
    ): Promise<Tivet.identity.PrepareAvatarUploadResponse> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.TivetEnvironment.Production,
     ...
     * Completes an avatar image upload. Must be called after the file upload process completes.
     *
     * @param {Tivet.identity.SignupForBetaRequest} request
     * @param {Identity.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Tivet.InternalError}
     * @throws {@link Tivet.RateLimitError}
    ...
    public async signupForBeta(
        request: Tivet.identity.SignupForBetaRequest,
        requestOptions?: Identity.RequestOptions
    ): Promise<void> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
