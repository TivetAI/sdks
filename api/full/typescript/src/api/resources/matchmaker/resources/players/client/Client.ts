...
export class Players {
     ...
     *
     * @param {Tivet.matchmaker.PlayerConnectedRequest} request
    ...
    public async connected(
        request: Tivet.matchmaker.PlayerConnectedRequest,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.TivetTimeoutError("Timeout exceeded when calling POST /matchmaker/players/connected.");
            case "unknown":
                throw new errors.TivetError({
     ...
     *
     * @param {Tivet.matchmaker.PlayerDisconnectedRequest} request
     * @param {Players.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Tivet.InternalError}
     * @throws {@link Tivet.RateLimitError}
    ...
    public async disconnected(
        request: Tivet.matchmaker.PlayerDisconnectedRequest,
        requestOptions?: Players.RequestOptions
    ): Promise<void> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
    ...
    public async getStatistics(
        requestOptions?: Players.RequestOptions
    ): Promise<Tivet.matchmaker.GetStatisticsResponse> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.TivetEnvironment.Production,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.TivetTimeoutError("Timeout exceeded when calling GET /matchmaker/players/statistics.");
            case "unknown":
                throw new errors.TivetError({
                    message: _response.error.errorMessage,
                });
