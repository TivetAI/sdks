...
export class Lobbies {
    ...
    public async ready(requestOptions?: Lobbies.RequestOptions): Promise<void> {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.TivetTimeoutError("Timeout exceeded when calling POST /matchmaker/lobbies/ready.");
            case "unknown":
                throw new errors.TivetError({
     ...
     * for mock responses. When running on Tivet servers, you can access the given lobby token from the
     * [`TIVET_TOKEN`](/docs/matchmaker/concepts/lobby-env) environment variable.
     *
     * @param {Tivet.matchmaker.SetLobbyClosedRequest} request
     * @param {Lobbies.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Tivet.InternalError}
     * @throws {@link Tivet.RateLimitError}
    ...
    public async setClosed(
        request: Tivet.matchmaker.SetLobbyClosedRequest,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.TivetTimeoutError("Timeout exceeded when calling PUT /matchmaker/lobbies/closed.");
            case "unknown":
                throw new errors.TivetError({
                    message: _response.error.errorMessage,
                });
    ...
    public async setState(request?: unknown, requestOptions?: Lobbies.RequestOptions): Promise<void> {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.TivetTimeoutError("Timeout exceeded when calling PUT /matchmaker/lobbies/state.");
            case "unknown":
                throw new errors.TivetError({
                    message: _response.error.errorMessage,
                });
     ...
     *
     * @param {Tivet.matchmaker.FindLobbyRequest} request
     * @param {Lobbies.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Tivet.InternalError}
     * @throws {@link Tivet.RateLimitError}
     ...
     */
    public async find(
        request: Tivet.matchmaker.FindLobbyRequest,
        requestOptions?: Lobbies.RequestOptions
    ): Promise<Tivet.matchmaker.FindLobbyResponse> {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.TivetTimeoutError("Timeout exceeded when calling POST /matchmaker/lobbies/find.");
            case "unknown":
                throw new errors.TivetError({
                    message: _response.error.errorMessage,
                });
     ...
     * can be used for general authentication.
     *
     * @param {Tivet.matchmaker.JoinLobbyRequest} request
     * @param {Lobbies.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Tivet.InternalError}
     * @throws {@link Tivet.RateLimitError}
     ...
     */
    public async join(
        request: Tivet.matchmaker.JoinLobbyRequest,
        requestOptions?: Lobbies.RequestOptions
    ): Promise<Tivet.matchmaker.JoinLobbyResponse> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.TivetEnvironment.Production,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.TivetTimeoutError("Timeout exceeded when calling POST /matchmaker/lobbies/join.");
            case "unknown":
                throw new errors.TivetError({
                    message: _response.error.errorMessage,
                });
     ...
     * can be used for general authentication.
     *
     * @param {Tivet.matchmaker.CreateLobbyRequest} request
     * @param {Lobbies.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Tivet.InternalError}
     * @throws {@link Tivet.RateLimitError}
     ...
     */
    public async create(
        request: Tivet.matchmaker.CreateLobbyRequest,
        requestOptions?: Lobbies.RequestOptions
    ): Promise<Tivet.matchmaker.CreateLobbyResponse> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.TivetEnvironment.Production,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.TivetTimeoutError("Timeout exceeded when calling POST /matchmaker/lobbies/create.");
            case "unknown":
                throw new errors.TivetError({
                    message: _response.error.errorMessage,
                });
     ...
     * can be used for general authentication.
     *
     * @param {Tivet.matchmaker.ListLobbiesRequest} request
     * @param {Lobbies.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Tivet.InternalError}
     * @throws {@link Tivet.RateLimitError}
     ...
     */
    public async list(
        request: Tivet.matchmaker.ListLobbiesRequest = {},
        requestOptions?: Lobbies.RequestOptions
    ): Promise<Tivet.matchmaker.ListLobbiesResponse> {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.TivetTimeoutError("Timeout exceeded when calling GET /matchmaker/lobbies/list.");
            case "unknown":
                throw new errors.TivetError({
                    message: _response.error.errorMessage,
                });
