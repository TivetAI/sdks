...
export class Regions {
     ...
     */
    public async list(requestOptions?: Regions.RequestOptions): Promise<Tivet.matchmaker.ListRegionsResponse> {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.TivetTimeoutError("Timeout exceeded when calling GET /matchmaker/regions.");
            case "unknown":
                throw new errors.TivetError({
