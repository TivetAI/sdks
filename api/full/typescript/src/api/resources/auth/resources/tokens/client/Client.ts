...
export class Tokens {
     ...
     *
     * @param {Tivet.auth.RefreshIdentityTokenRequest} request
    ...
    public async refreshIdentityToken(
        request: Tivet.auth.RefreshIdentityTokenRequest,
        requestOptions?: Tokens.RequestOptions
    ): Promise<Tivet.auth.RefreshIdentityTokenResponse> {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.TivetTimeoutError("Timeout exceeded when calling POST /auth/tokens/identity.");
            case "unknown":
                throw new errors.TivetError({
