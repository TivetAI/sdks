...
export class Games {
     ...
     *
     * @param {string} gameNameId - A human readable short identifier used to references resources. Different than a `tivet.common#Uuid` because this is intended to be human readable. Different than `tivet.common#DisplayName` because this should not include special characters and be short.
     * @param {Tivet.portal.GetGameProfileRequest} request
    ...
    public async getGameProfile(
        gameNameId: string,
        request: Tivet.portal.GetGameProfileRequest = {},
        requestOptions?: Games.RequestOptions
    ): Promise<Tivet.portal.GetGameProfileResponse> {
