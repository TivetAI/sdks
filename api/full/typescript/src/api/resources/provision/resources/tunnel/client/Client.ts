...
export class Tunnel {
     ...
     */
    public async getTls(requestOptions?: Tunnel.RequestOptions): Promise<Tivet.provision.tunnel.GetTlsResponse> {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.TivetTimeoutError("Timeout exceeded when calling GET /tunnel/tls.");
            case "unknown":
                throw new errors.TivetError({
