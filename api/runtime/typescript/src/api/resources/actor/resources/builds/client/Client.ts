...
export class Builds {
     ...
     *
     * @param {string} build
     * @param {Tivet.actor.GetBuildRequestQuery} request
    ...
    public async get(
        build: string,
        request: Tivet.actor.GetBuildRequestQuery = {},
        requestOptions?: Builds.RequestOptions
    ): Promise<Tivet.actor.GetBuildResponse> {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.TivetTimeoutError("Timeout exceeded when calling GET /builds/{build}.");
            case "unknown":
                throw new errors.TivetError({
     ...
     *
     * @param {Tivet.actor.ListBuildsRequestQuery} request
     * @param {Builds.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Tivet.InternalError}
     * @throws {@link Tivet.RateLimitError}
     ...
     */
    public async list(
        request: Tivet.actor.ListBuildsRequestQuery = {},
        requestOptions?: Builds.RequestOptions
    ): Promise<Tivet.actor.ListBuildsResponse> {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.TivetTimeoutError("Timeout exceeded when calling GET /builds.");
            case "unknown":
                throw new errors.TivetError({
                    message: _response.error.errorMessage,
                });
    ...
    /**
     * @param {string} build
     * @param {Tivet.actor.PatchBuildTagsRequestQuery} request
     * @param {Builds.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Tivet.InternalError}
     * @throws {@link Tivet.RateLimitError}
    ...
    public async patchTags(
        build: string,
        request: Tivet.actor.PatchBuildTagsRequestQuery,
        requestOptions?: Builds.RequestOptions
    ): Promise<Tivet.actor.PatchBuildTagsResponse> {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.TivetTimeoutError("Timeout exceeded when calling PATCH /builds/{build}/tags.");
            case "unknown":
                throw new errors.TivetError({
                    message: _response.error.errorMessage,
                });
     ...
     *
     * @param {Tivet.actor.PrepareBuildRequestQuery} request
     * @param {Builds.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Tivet.InternalError}
     * @throws {@link Tivet.RateLimitError}
    ...
    public async prepare(
        request: Tivet.actor.PrepareBuildRequestQuery,
        requestOptions?: Builds.RequestOptions
    ): Promise<Tivet.actor.PrepareBuildResponse> {
        const { project, environment, body: _body } = request;
        const _queryParams: Record<string, string | string[] | object | object[]> = {};
        if (project != null) {
            _queryParams["project"] = project;
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.TivetTimeoutError("Timeout exceeded when calling POST /builds/prepare.");
            case "unknown":
                throw new errors.TivetError({
                    message: _response.error.errorMessage,
                });
     ...
     *
     * @param {string} build
     * @param {Tivet.actor.CompleteBuildRequestQuery} request
     * @param {Builds.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Tivet.InternalError}
     * @throws {@link Tivet.RateLimitError}
    ...
    public async complete(
        build: string,
        request: Tivet.actor.CompleteBuildRequestQuery = {},
        requestOptions?: Builds.RequestOptions
    ): Promise<void> {
        const { project, environment } = request;
        const _queryParams: Record<string, string | string[] | object | object[]> = {};
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.TivetTimeoutError("Timeout exceeded when calling POST /builds/{build}/complete.");
            case "unknown":
                throw new errors.TivetError({
                    message: _response.error.errorMessage,
                });
