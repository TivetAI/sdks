...
export class Regions {
    ...
    /**
     * @param {Tivet.actor.ListRegionsRequestQuery} request
     ...
     */
    public async list(
        request: Tivet.actor.ListRegionsRequestQuery = {},
        requestOptions?: Regions.RequestOptions
    ): Promise<Tivet.actor.ListRegionsResponse> {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.TivetTimeoutError("Timeout exceeded when calling GET /regions.");
            case "unknown":
                throw new errors.TivetError({
    ...
    /**
     * @param {Tivet.actor.ResolveRegionsRequestQuery} request
     * @param {Regions.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Tivet.InternalError}
     * @throws {@link Tivet.RateLimitError}
    ...
    public async resolve(
        request: Tivet.actor.ResolveRegionsRequestQuery = {},
        requestOptions?: Regions.RequestOptions
    ): Promise<Tivet.actor.ResolveRegionResponse> {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.TivetTimeoutError("Timeout exceeded when calling GET /regions/resolve.");
            case "unknown":
                throw new errors.TivetError({
                    message: _response.error.errorMessage,
                });
